...
class CameraOverlay: UIView, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func addPhotoButton() {
        ...
        photoButton.frame = CGRect(
            ...
            y: frame.height - (resetButton.center.y + cameraButtonDiameter / 2),
